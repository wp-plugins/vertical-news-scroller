...
== Description ==
 Vertical News Scroller is pligin for display a vertical scrolling news for WordPress blog.Admin can manage any number of news.Admin can add,edit delete news.
